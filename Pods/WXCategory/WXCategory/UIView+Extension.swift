...
public extension UIView {
    ...
    /// - Returns: 返回xib对应的视图
    public static func loadViewFromNib(nibName:String) -> UIView? {
    ...
    ///   - left: 横线距离左侧间距  默认15
    ///   - right: 横线距离右侧间距  默认0
    public func addBottomLineWith(color:UIColor, size:CGFloat = 0.5, left:CGFloat = 15.0, right:CGFloat = 0.0) {
        let lineView = UIView()
